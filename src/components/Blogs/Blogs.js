...
const Blogs = () => {
    return (
        <div className='q-a-section'>
            ...
            <h5><li>Semantic HTML tag clearly describe to both browser and developer. what is going to be happen on web page. semantic tag usage essential in web page for building meaningful application. there are different type of semantic tag.Example is: header tag for Head section, nav tag for nav section, article tag for article section, footer tag for footer section etc.</li></h5>
